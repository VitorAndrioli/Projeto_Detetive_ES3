...
<div class="col-xs-12 col-sm-8 col-sm-offset-2 col-xs-offset-2">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form method="POST" action="${contextPath}/deck/card/${card.id}" enctype="multipart/form-data"
                  runat="server">
                ...
                <div class="form-group">
                    <center>
                        <div class="card flex-col flex-stretch"
                             style="background-image: url(<c:url value="/cards/fundo.jpg"/>);">
                            <div class="name-container flex-row flex-center-b">
                                <p class="flex" id="cardName" style="text-align: left" id="cardName"> ${card.name}</p>
                                <p id="cardType"></p>
                            </div>
